...
const conditions = (props) => {
        ...
        return ( <
                div className = { classes.Wrapper } > { props.error && < small > < strong > Please enter a city. < /strong></small > } {
                                ...
                                p > < strong > { props.responseObj.name } < /strong></p > {
                                    ...
                                    degrees < /p>} {
                                        props.responseObj.weather[0] && < p > Outside is { props.responseObj.weather[0].description }. < /p>} {
                                            ...
                                            pa < /p>} {
                                                props.responseObj.main.humidity && < p > The humidity is { props.responseObj.main.humidity } < /p>} {
                                                    props.responseObj.sys.country && < p > At { props.responseObj.name }, { isoCountries[props.responseObj.sys.country] } < /p>} <
                                                        /div>:
                                                        <
                                                        div > < /div> 
                                                }
